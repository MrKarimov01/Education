...
const Menedjer__page = () => {
  return (
    <div className="Menedjer__page">
      <div className="manadger__page-in">
        <p className="pmenedjer">
          Персональный менеджер
        </p>
        <div className="manadger__inner">
          <img className="img2" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS5lr2uxXdbKkcJ0dGlev6nGlWlMMoy4pim5g&usqp=CAU" alt="Picture" />
          <p className="birnima">Nargiza Akhmedova</p>
        </div>
      </div>
